        ...
        <Box className='login_pag'>
            <Box className='login_container'>
                <Box className="login_left">
                    ...
                    <img src={login2} alt="logopic" className='login_pict' />
                </Box>
                <Box className="login_right">
                    ...
                    <Box className="login_right_inner">
                        ...
                        <Typography className="subtitle login_subtitle">You are only one step a way from your
                            new password, recover your password now.</Typography>
                        ...
                        <TextField
                            ...
                            className="input_field cus_password cus2"
                        />
